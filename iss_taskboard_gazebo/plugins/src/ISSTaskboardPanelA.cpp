...
#include "../include/ISSTaskboardPanelA.h"
...
bool GazeboTaskboardSlot1::InitLinks()
{
    ...
    } linksInfo[] = 
    {
        ...
        { linkA01Switch         , "taskboard_slot1_switch0"         },
...
void GazeboTaskboardSlot1::Led::CreateModel(physics::WorldPtr world)
{
    ...
    std::string ledModel;
    ledModel = boost::str(boost::format("<cylinder> <length>%1%</length> <radius>%2%</radius> </cylinder>")
