...
#include <iss_taskboard_gazebo/ManipulatePowerSwitch.h>
#include <iss_taskboard_gazebo/ManipulateRockerSwitch.h>
#include <iss_taskboard_gazebo/ManipulateNumPad.h>
#include <iss_taskboard_gazebo/ManipulateSafeToggle.h>

#include <iss_taskboard_gazebo/TaskboardPanelA.h>
...
namespace gazebo
{
    ...
    */
    ...
    private:
        ...
        bool ManipulatePowerCover(iss_taskboard_gazebo::ManipulatePowerCover::Request& request,
                                  iss_taskboard_gazebo::ManipulatePowerCover::Response& response);
        /// @brief Peforms power switch manipulation.
        bool ManipulatePowerSwitch(iss_taskboard_gazebo::ManipulatePowerSwitch::Request& request,
                                   iss_taskboard_gazebo::ManipulatePowerSwitch::Response& response);
        /// @brief Peforms rocker switch manipulation.
        bool ManipulateRockerSwitch(iss_taskboard_gazebo::ManipulateRockerSwitch::Request& request,
                                    iss_taskboard_gazebo::ManipulateRockerSwitch::Response& response);
        /// @brief Peforms numpad buttons manipulation.
        bool ManipulateNumPad(iss_taskboard_gazebo::ManipulateNumPad::Request& request,
                              iss_taskboard_gazebo::ManipulateNumPad::Response& response);
        /// @brief Peforms safe toggle (A03/A04/A05) manipulation.
        bool ManipulateSafeToggle(iss_taskboard_gazebo::ManipulateSafeToggle::Request& request,
